//! Huge Trigger Input Implementation
//!
...
/// Huge Trigger Input using EXTI interrupts.
...
pub async fn crank_exti_task(
    ...
    defmt::info!("Huge crank EXTI task started on PA8");
...
pub async fn cam_exti_task(
    ...
    defmt::info!("Huge cam EXTI task started on PA5");
