//! Huge CAN bus driver using embassy-stm32 bxcan (CAN1).
//!
...
impl Stm32CanDriver {
    /// Initialise queues and return driver + task resources.
...
/// Embassy task that drives the CAN1 hardware.
pub async fn can_task(mut can: Can<'static>, mut resources: CanTaskResources) {
    can.set_bitrate(500_000);

    defmt::info!("Huge CAN1 task started @ 500 kbit/s");
