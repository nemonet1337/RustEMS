//! Proteus Trigger Input Implementation
//!
...
// PA5 (EXTI5) and PA8 (EXTI8) both use the shared EXTI9_5 interrupt on STM32F7.
bind_interrupts!(struct ExtiIrqs {
    EXTI9_5 => exti::InterruptHandler<embassy_stm32::interrupt::typelevel::EXTI9_5>;
});

/// Proteus Trigger Input using EXTI interrupts.
...
pub async fn crank_exti_task(
    ...
    defmt::info!("Proteus crank EXTI task started on PA8");
...
pub async fn cam_exti_task(
    ...
    defmt::info!("Proteus cam EXTI task started on PA5");
