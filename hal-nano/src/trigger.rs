//! Nano Trigger Input Implementation
//!
...
/// Nano Trigger Input using EXTI interrupts.
...
pub async fn crank_exti_task(
    ...
    defmt::info!("Nano crank EXTI task started on PA8");
...
pub async fn cam_exti_task(
    ...
    defmt::info!("Nano cam EXTI task started on PA5");
