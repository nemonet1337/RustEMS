...
pub mod heapless_vec {
    ...
    pub fn decode<'b, T: minicbor::Decode<'b, C>, const N: usize, C>(
        ...
        let len = d
            .array()?
            .ok_or_else(|| DecodeError::message("expected array for heapless::Vec"))?;
        if len > N as u64 {
        ...
        for _ in 0..len {
            vec.push(T::decode(d, ctx)?)
                .map_err(|_| DecodeError::message("failed to push to heapless::Vec"))?;
        }
        Ok(vec)
    }
}
...
impl<'b, C> minicbor::Decode<'b, C> for ErrorCode {
    fn decode(
        ...
        ErrorCode::from_u16(val)
            .ok_or_else(|| minicbor::decode::Error::message("invalid ErrorCode"))
    }
}
...
pub struct GetSchemaInfoResponse<'a> {
    ...
    pub table_count: u16,
    #[b(3)]
    #[cbor(with = "crate::cbor::heapless_vec")]
    pub categories: heapless::Vec<CategoryDesc<'a>, 16>,
}
...
pub struct ParamDesc<'a> {
    ...
    pub flags: u8,
    #[b(13)]
    #[cbor(with = "crate::cbor::heapless_vec_opt")]
    pub enum_labels: Option<heapless::Vec<&'a str, 16>>,
}
...
pub struct GetParamCatalogResponse<'a> {
    ...
    #[b(2)]
    #[cbor(with = "crate::cbor::heapless_vec")]
    pub items: heapless::Vec<ParamDesc<'a>, 8>,
}
...
pub struct TableDesc<'a> {
    ...
    pub y_size: u16,
    #[b(7)]
    pub x_axis_key: &'a str,
    #[b(8)]
    pub y_axis_key: &'a str,
    #[b(9)]
    pub x_unit: &'a str,
    #[b(10)]
    pub y_unit: &'a str,
...
pub struct GetTableCatalogResponse<'a> {
    ...
    #[b(2)]
    #[cbor(with = "crate::cbor::heapless_vec")]
    pub items: heapless::Vec<TableDesc<'a>, 8>,
}
...
pub struct GetTelemetryCatalogResponse<'a> {
    ...
    #[b(2)]
    #[cbor(with = "crate::cbor::heapless_vec")]
    pub items: heapless::Vec<ChannelDesc<'a>, 8>,
}
...
pub struct ParamGetResponse<'a> {
    #[b(0)]
    #[cbor(with = "crate::cbor::heapless_vec")]
    pub values: heapless::Vec<ParamValue<'a>, 32>,
}
...
pub struct ParamSetRequest<'a> {
    #[b(0)]
    #[cbor(with = "crate::cbor::heapless_vec")]
    pub entries: heapless::Vec<ParamSetEntry<'a>, 32>,
}
...
pub struct ParamSetResponse {
    #[n(0)]
    #[cbor(with = "crate::cbor::heapless_vec")]
    pub results: heapless::Vec<ParamSetResult, 32>,
}
...
pub struct TableSetAxisRequest {
    ...
    #[n(2)]
    #[cbor(with = "crate::cbor::heapless_vec")]
    pub values: heapless::Vec<f32, 16>,
}
...
pub struct SubscribeRequest {
    #[n(0)]
    #[cbor(with = "crate::cbor::heapless_vec")]
    pub channels: heapless::Vec<u16, 32>,
    #[n(1)]
    pub rate_hz: u16,
}
...
pub struct SubscribeResponse {
    ...
    #[n(1)]
    #[cbor(with = "crate::cbor::heapless_vec")]
    pub layout: heapless::Vec<u16, 32>,
...
pub struct ReadOnceResponse {
    #[n(0)]
    #[cbor(with = "crate::cbor::heapless_vec")]
    pub values: heapless::Vec<f32, 32>,
}
...
pub struct GetFaultsResponse {
    #[n(0)]
    #[cbor(with = "crate::cbor::heapless_vec")]
    pub faults: heapless::Vec<FaultEntry, 16>,
}
