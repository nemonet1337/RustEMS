...
impl SimAdcInput {
    ...
    pub fn set_maf(&mut self, raw: u16)          { self.maf_raw          = raw; }
    pub fn set_fuel_level(&mut self, raw: u16)   { self.fuel_level_raw   = raw; }
    pub fn set_oil_pressure(&mut self, raw: u16) { self.oil_pressure_raw = raw; }
    pub fn set_lambda1(&mut self, raw: u16)      { self.lambda1_raw      = raw; }
    pub fn set_lambda2(&mut self, raw: u16)      { self.lambda2_raw      = raw; }
}
