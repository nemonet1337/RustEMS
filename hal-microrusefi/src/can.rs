//! microRusEFI CAN bus driver using embassy-stm32 bxcan (CAN1).
//!
...
use embassy_stm32::can::frame::{Frame as EmbassyFrame, Envelope};
...
pub async fn can_task(mut can: Can<'static>, mut resources: CanTaskResources) {
    ...
    defmt::info!("microRusEFI CAN1 task started @ 500 kbit/s");
