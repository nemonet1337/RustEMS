//! UAEFI ADC Input Implementation
//!
//! Uses ADC1 with 5 analogue channels (plus internal baro via I2C/SPI).
...
impl AdcInput for Stm32AdcInput {
    fn read_raw(&mut self, channel: AdcChannel) -> u16 {
        match channel {
            ...
            _ => 0, // Baro and other channels via I2C/SPI in future
        }
    }
}
